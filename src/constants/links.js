export const SEVEN_PATH_AWAKENING_PURCHASE_URL =
  'https://payhip.com/order?link=cw6mx&pricing_plan=nKGvx6OLzb';
...
// Formspree form — submissions also sent here for redundancy
export const FORMSPREE_ENDPOINT = 'https://formspree.io/f/mqevzdeg';
