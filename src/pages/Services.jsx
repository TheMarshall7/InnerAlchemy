...
const Services = () => {
  ...
  const services = [
    ...
    { num: "03", title: "MTVSS Immune System", duration: "60 minutes", desc: "A powerful Access Consciousness hands-on body process to boost immunity by activating 32 energies focused on the liver, spleen, glands, and kidneys.", benefits: "Immune strength, Cellular regeneration, Chronic fatigue. Your body begins to remember its natural intelligence.", img: "https://images.unsplash.com/photo-1475924156734-496f6cac6ec1", price: "$75", tag: null },
    { num: "04", title: "Emotional Trauma Release", duration: "60 minutes", desc: "A subconscious–somatic clearing process that melts emotional blockages stored along the spine by accessing and releasing energetic memory and tension.", benefits: "Childhood wounds, Panic, Heart heaviness. Gives the inner child safety and release.", img: "https://images.unsplash.com/photo-1490730141103-6cac27aaab94", price: "$75", tag: null },
    { num: "05", title: "Energetic Facelift", duration: "60 minutes", desc: "A high-frequency hands-on process that rejuvenates your face and body by lifting stagnant energy, restoring vitality, and renewing your glow from within.", benefits: "Emotional softness, Rejuvenation, Glow and vitality, Energetic harmony.", img: "https://images.unsplash.com/photo-1499209974431-9dddcece7f88", price: "$75", tag: null },
    { num: "06", title: "Brain Capacity Activation", duration: "60 minutes", desc: "A session that awakens dormant mental pathways and clears subconscious blocks around clarity, focus, and decision-making. Aligns the divine and human mind to enhance focus and intuitive access.", benefits: "Memory, Creativity, Intuition. Perfect for students, creators, and healers.", img: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e", price: "$75", tag: null },
    { num: "07", title: "Manifestation Energy Activation", duration: "60 minutes", desc: "A deep energetic process that aligns your frequency with your desires, dissolving resistance and activating receiving energy. Your energy already knows the way.", benefits: "Aligning mind + energy + intention, Attracting new opportunities.", img: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b", price: "$75", tag: null },
    { num: "08", title: "Full Moon Meditation & Mantras", duration: "Group Gathering", desc: "An energetic portal ceremony held each Full Moon. Each gathering is tailored to the sign and element of the Moon, using the ruling planet as an archetype to guide deep shadow work, release, and renewal.", benefits: "Energetic cleansing, intuitive insight, collective healing. Full Moon energy amplifies transformation.", img: "https://images.unsplash.com/photo-1462275646964-a0e3386b89fa", price: "$45", tag: "Group" }
  ];
                ...
                <div className={`md:col-span-7 space-y-8 md:space-y-12 ${isEven ? 'order-2' : 'order-2 md:order-1'}`}>
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {service.price && <span className="text-deepbrown font-serif text-lg">{service.price}</span>}
                    </div>
                  </div>
