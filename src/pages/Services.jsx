...
const Services = () => {
  ...
  const services = [
    ...
    { num: "03", title: "MTVSS Immune System", duration: "60 minutes", desc: "A powerful Access Consciousness hands-on body process to boost immunity by activating 32 energies focused on the liver, spleen, glands, and kidneys.", benefits: "Immune strength, Cellular regeneration, Chronic fatigue. Your body begins to remember its natural intelligence.", img: "https://images.unsplash.com/photo-1475924156734-496f6cac6ec1?q=60&w=800&auto=format&fit=crop", price: "$75", tag: null },
