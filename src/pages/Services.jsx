...
const Services = () => {
  ...
  const services = [
    ...
    { num: "05", title: "Brain Capacity Activation", duration: "60 minutes", desc: "A session that awakens dormant mental pathways and clears subconscious blocks around clarity, focus, and decision-making.", benefits: "Memory, Creativity, Intuition. Perfect for students, creators, and healers.", img: "https://images.unsplash.com/photo-1441974231531-c6227dbb6b6e" },
