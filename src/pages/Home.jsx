    ...
    <div className="w-full bg-sand selection:bg-rust selection:text-sand" ref={containerRef}>
      ...
      <section className="relative min-h-[100svh] pt-32 pb-20 md:py-0 flex items-center overflow-hidden bg-dust">
        ...
        <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 grid md:grid-cols-12 gap-0 items-center relative z-10">
          ...
          }} className="md:col-span-6 lg:col-span-7 pt-12 sm:pt-16 md:pt-16 md:pl-12 lg:pl-24 z-20">
            <motion.div variants={fadeUp} className="flex items-center gap-4 mb-6 md:mb-8">
              <div className="h-px w-12 bg-terracotta/40"></div>
              <span className="text-ochre tracking-[0.2em] sm:tracking-[0.25em] text-[8px] md:text-[10px] uppercase font-semibold">Eternal Source Academy</span>
            </motion.div>
      ...
      <section className="py-20 md:py-32 lg:py-56 relative bg-sand z-20 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-serif text-deepbrown leading-[1.1] tracking-tight mb-10 md:mb-16 text-balance">
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="mb-20 md:mb-32 flex flex-col md:flex-row justify-between md:items-end gap-8 border-b border-deepbrown/10 pb-12">
            <div>
              ...
              <h2 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-serif text-deepbrown leading-none text-balance">Explore <span className="italic text-clay">Pathways</span></h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 lg:gap-10 auto-rows-[minmax(320px,auto)] md:auto-rows-[500px]">
            ...
            >
              ...
              <div className="absolute inset-x-10 bottom-10 md:inset-x-20 md:bottom-20 z-10 flex flex-col items-start text-white">
                ...
                <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif mb-6 md:mb-8 leading-tight">Private <br/><span className="italic text-sand/60">Alchemy</span></h3>
            ...
            <motion.div 
              ...
              className="md:col-span-4 lg:col-span-4 row-span-1 border border-deepbrown/10 bg-white/40 backdrop-blur-xl p-8 sm:p-10 md:p-16 flex flex-col justify-between hover:bg-white transition-all duration-700 group rounded-[32px] sm:rounded-[40px] md:rounded-[60px] shadow-xl hover:shadow-[0_40px_80px_rgba(42,31,26,0.1)] overflow-hidden relative hover:-translate-y-2"
            >
              ...
              <div className="relative z-10">
                 ...
                 <span className="text-terracotta text-[11px] tracking-[0.3em] uppercase mb-4 block font-semibold">Professional Mastery — {SEVEN_PATH_AWAKENING_PRICE}</span>
                 <h3 className="text-3xl sm:text-4xl font-serif text-deepbrown mb-4 sm:mb-6 group-hover:text-terracotta transition-colors leading-tight">7-Path <br/><span className="italic">Certification</span></h3>
            ...
            <motion.div 
              ...
              className="md:col-span-4 lg:col-span-4 row-span-1 bg-deepbrown p-8 sm:p-10 md:p-16 flex flex-col justify-between overflow-hidden relative group rounded-[32px] sm:rounded-[40px] md:rounded-[60px] shadow-xl hover:shadow-[0_40px_80px_rgba(42,31,26,0.3)] transition-all duration-700 hover:-translate-y-2"
            >
              ...
              <div className="relative z-10">
                 ...
                 <h3 className="text-3xl sm:text-4xl font-serif text-white mb-4 sm:mb-6 leading-tight">Digital <br/><span className="italic text-terracotta/80">Alchemy</span></h3>
      ...
      <section className="py-24 md:py-32 bg-clay relative overflow-hidden z-20 shadow-inner">
        ...
        <div className="max-w-[1400px] mx-auto px-6 text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-serif text-white mb-8 md:mb-12 leading-tight text-balance">
