...
const Home = () => {
  ...
  return (
    <div className="w-full bg-sand selection:bg-rust selection:text-sand" ref={containerRef}>
      ...
      <section className="py-24 md:py-64 relative bg-sand z-20">
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 lg:px-24 bg-dust relative z-20 overflow-hidden">
        <div className="max-w-[1400px] mx-auto bg-dust">
          
          <div className="mb-20 md:mb-48 border-b border-deepbrown/10 pb-12 flex justify-between items-end">
          ...
          <div className="space-y-32 md:space-y-48">
            ...
            <div className="grid md:grid-cols-12 gap-12 items-center">
              <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: 'easeOut' }} viewport={{ once: true }} className="md:col-span-7 h-[400px] md:h-[600px] overflow-hidden relative group">
                <div className="absolute inset-0 bg-sand/10 mix-blend-overlay z-10 transition-all duration-1000"></div>
                <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=2000&auto=format&fit=crop" alt="Healing session" className="w-full h-full object-cover scale-105 group-hover:scale-100 transition-transform duration-[2s] ease-out brightness-105" />
              </motion.div>
            ...
            <div className="grid md:grid-cols-12 gap-12 items-center">
              ...
              <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: 'easeOut', delay: 0.2 }} viewport={{ once: true }} className="md:col-span-7 md:col-start-6 h-[400px] md:h-[600px] overflow-hidden relative group order-1 md:order-2">
                ...
                <img src="https://images.unsplash.com/photo-1518241353330-0f7941c2d5e5?q=80&w=2000&auto=format&fit=crop" alt="Inner peace" className="w-full h-full object-cover scale-105 group-hover:scale-100 transition-transform duration-[2s] ease-out brightness-110" />
              </motion.div>
            </div>
          </div>
        </div>
